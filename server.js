...
app.post('/api/chat', checkAppKey, async (req, res) => {
  ...
  try {
    ...
    const systemPrompt = `Você é SextaFeira, o assistente pessoal do usuário. Responda em português do Brasil, de forma direta e simpática. Se perguntarem seu nome, diga que é SextaFeira.
